        ...
        while current_char is not None:
            ...
            if current_char == ';':
                ...
                if next_char == ' ': # handle single char case
                    ...
                    tokens.append(Token(TokenType(current_char + next_char), current_char + next_char, self.line, self.column))
                else:
                    raise ValueError(f"Unexpected operator '{current_char, next_char}' at line {self.line}, column {self.column}")
